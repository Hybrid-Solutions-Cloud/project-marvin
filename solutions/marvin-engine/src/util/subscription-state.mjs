...
function normalizeWebhookState(webhooks = {}) {
  ...
  return {
    microsoft: {
      ...
      lastValidationTokenHash: normalizeString(microsoft.lastValidationTokenHash),
      ...
      notificationsRejected: Number(microsoft.notificationsRejected || 0),
      ...
      lastLifecycleEvents: normalizeStringList(microsoft.lastLifecycleEvents)
    },
    google: {
