...
Prepare the Paranoid Keeper runtime for Azure Container Apps. Project Marvin remains the public repository and visual theme; Paranoid Keeper is the deployed calendar-sync product.
...
- Successful validation of every configured account automatically starts the Paranoid Keeper daemon.
