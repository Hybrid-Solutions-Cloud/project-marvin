...
Paranoid Keeper must provide fully automated bidirectional calendar mirroring.
...
7. Setup links and validates Microsoft 365, Outlook, Google, and optional Apple / CalDAV accounts.
