...
2. `ridafkih/keeper.sh` as the most relevant open-source example of a broader multi-provider sync engine.
3. A custom Graph plus CalDAV service if your priority is long-term ownership and scripted deployment.
