...
> **Archival reference — unsupported.** This Power Automate design is retained for research and migration context. It is not a Project Marvin installation or deployment path.

## Summary

Bureaucratic Flow was the Power Automate experiment for Project Marvin.
