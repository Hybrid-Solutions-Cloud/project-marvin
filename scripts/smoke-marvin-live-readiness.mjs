...
assert.equal(liveResult.skipped, 2);
...
assert.equal(liveResult.cleanup.attempted, 0);
assert.ok(liveResult.mappings.some((item) => item.sourceEventId === "stale-work-event"));
